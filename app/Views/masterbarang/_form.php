...
// Define $item for create/edit so form reads consistently
$item = $item ?? [];
?>
<div class="form-row">
  <div class="form-group col-md-6">
    ...
    <input type="text" id="NamaLengkap" name="NamaLengkap"
      ...
      value="<?= esc(old('NamaLengkap', $item['NamaLengkap'] ?? '')) ?>" <?= empty($item) ? 'autofocus' : '' ?>>
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" id="PCode" name="PCode"
      ...
      value="<?= esc(old('PCode', $item['PCode'] ?? '')) ?>">
...
<div class="form-row">
  <div class="form-group col-md-6">
    ...
    <input type="text" id="NamaStruk" name="NamaStruk" class="form-control" maxlength="30"
      placeholder="Nama singkat untuk cetak struk"
      value="<?= esc(old('NamaStruk', $item['NamaStruk'] ?? '')) ?>">
  </div>

  <div class="form-group col-md-3">
    <label for="SatuanSt">Satuan</label>
    <?php $units = ['pcs' => 'PCS', 'pack' => 'PACK', 'crat' => 'CRAT'];
      $selectedUnit = strtolower(old('SatuanSt', $item['SatuanSt'] ?? 'pcs'));
    ?>
  ...
  <div class="form-group col-md-3">
    ...
    <input type="text" id="Barcode1" name="Barcode1" class="form-control"
      value="<?= esc(old('Barcode1', $item['Barcode1'] ?? '')) ?>">
  </div>
...
<div class="form-group">
  ...
  <select id="Status" name="Status" class="form-control">
    <?php $val = old('Status', $item['Status'] ?? 'T'); ?>
